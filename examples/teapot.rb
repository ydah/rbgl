...
shader = RLSL.define(:teapot_ruby) do
  ...
  functions do
    ...
    define :basis, returns: %i[vec3 vec3], params: { n: :vec3 }
  ...
  helpers do
    ...
    def bezier_dist(m, n, o, p)
      ...
      dot_s = 0.0000000001 if dot_s < 0.0000000001
      ...
      denom = x + x + y + z
      denom = 0.0000000001 if abs(denom) < 0.0000000001
    ...
    def calc_normal(p, ray, t, res_x)
      ...
      grad = vec3(grad.x - (ray.x * d), grad.y - (ray.y * d), grad.z - (ray.z * d)) if d > 0.0
